...
export default function Logo(props) {
  const timeOffset = 0.45;
  return (
    <React.Fragment>
      <Container>
        <TextPath timeOffset={timeOffset} />
      </Container>
      <Container>
        <TextPath timeOffset={timeOffset} color={props.theme.bg} />
      </Container>
    </React.Fragment>
  );
}
...
const Path = styled.path`
  ...
  fill: none;
  stroke: ${(props) => (props.stroke ? props.stroke : "#f6df51")};
  stroke-width: 5px;
...
const TextPath = (props) => (
  <React.Fragment>
    ...
    <Path
      ...
      style={{ animationDelay: `${props.timeOffset}s` }}
    ...
    <Path
      ...
      stroke={props.color}
      transform="translate(-3.34 -90.57)"
      style={{ animationDelay: `${props.timeOffset * 2}s` }}
    ...
    <Path
      ...
      stroke={props.color}
      transform="translate(-3.34 -90.57)"
      style={{ animationDelay: `${props.timeOffset * 3}s` }}
    ...
    <Path
      ...
      stroke={props.color}
      transform="translate(-3.34 -90.57)"
      style={{ animationDelay: `${props.timeOffset * 4}s` }}
    ...
    <Path
      ...
      data-name="a"
      transform="translate(-3.34 -90.57)"
      style={{ animationDelay: `${props.timeOffset * 5}s` }}
...
const Container = (props) => (
  <svg
    ...
    viewBox="0 0 190.67 63.92"
    style={{ width: "30em", maxWidth: "40%", position: "absolute" }}
  >
    {props.children}
  </svg>
);
