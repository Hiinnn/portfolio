...
export const Logo = () => {
  ...
  return (
    <React.Fragment>
      <Container viewBox="0 0 190.67 63.92">
...
const TextPath = ({ color, timeOffset }) => {
  return (
    <React.Fragment>
      <Path
        id="P"
      ...
      <Path
        ...
        style={{ animationDelay: `${timeOffset}s` }}
      ...
      <Path
        ...
        stroke={color}
        transform="translate(-3.34 -90.57)"
        style={{ animationDelay: `${timeOffset * 2}s` }}
      ...
      <Path
        ...
        stroke={color}
        transform="translate(-3.34 -90.57)"
        style={{ animationDelay: `${timeOffset * 3}s` }}
      ...
      <Path
        ...
        stroke={color}
        transform="translate(-3.34 -90.57)"
        style={{ animationDelay: `${timeOffset * 4}s` }}
      ...
      <Path
        ...
        data-name="a"
        transform="translate(-3.34 -90.57)"
        style={{ animationDelay: `${timeOffset * 5}s` }}
